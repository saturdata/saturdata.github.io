    ...
    items: [
      {
        ...
        description: `Join hosts Shifra Williams and Sam LaFell as they introduce Saturdata - your weekend data community.
Learn about their backgrounds, the mission of the podcast, and what you can expect from future episodes
as they humanize the data world for the next generation.`,
      ...
      },
      {
        ...
        description: `Join hosts Sam and Shifra as they explore the realities of data roles.
Sam discusses a day in the life of a data engineer.
From the glamorous perceptions to the day-to-day challenges, they discuss the skills, stakeholders,
and the importance of understanding the "why" behind data projects.`,
      ...
      },
      {
        ...
        description: `Join hosts Sam and Shifra as they explore what it really means to be a data scientist.
From building predictive models to translating complex insights for stakeholders,
they discuss the balance between ad hoc requests, dashboard creation, and meaningful machine learning work.`,
      ...
      },
      {
        ...
        description: `Interviews don't have to suck! Join Sam and Shifra as they break down everything
you need to know about data career interviews.
From the good and the bad to the downright ridiculous,
they share real talk about what actually works in the interview process.`,
      ...
      },
      {
        ...
        description: `If we didn't get the job, at least we got a story out of it!
Join Sam and Shifra as they break down the most popular interview questions,
the wildest interview stories, and the benefits of the Zumba council.
Maybe the real interviews were the friends we made along the way?`,
      ...
      },
      {
        ...
        description: `[Sai Bysani](https://www.linkedin.com/in/saibysani18) shares the LinkedIn strategy that transformed his career.
Learn practical tips for content creation, comment strategies,
and why starting where you are beats waiting for perfection.`,
      ...
      },
      {
        ...
        description: `Your SQL is great. But can you actually ship?
Sam and Shifra kick off Season 1 (since Saturdata is zero-indexed) by covering the unsung
skills that separate someone who writes queries from someone who builds things:
terminal literacy, dependency management, Git, notebooks, and why UV might be Python's best friend right now.
Plus, a deep dive into Marimo, the notebook tool that fixes everything you hate about Jupyter.`,
      ...
      },
      {
        ...
        description: `Think you know SQL?
Sam and Shifra break down what separates a query writer from a true data thinker,
from basic selects all the way to distributed systems, query plans,
and the four pillars of production-ready code.
Plus: why your data provider's incentives are working against you,
how a 1,400-line monolith hid millions in overstated revenue,
and the one approach that will save you from silent, soul-crushing data failures.`,
      ...
      },
      {
        ...
        description: `What if your A/B test needed 67 years to reach statistical significance?
Sam found out the hard way.
Join Sam and Shifra as they demystify statistical testing for the real world of data work,
where the stakes are lower, the data is messier,
and your stakeholders definitely do not know what a p-value is.`,
      ...
      },
      {
        ...
        description: `Your chart is full of information. So why does no one know what it means?
Sam and Shifra break down everything you need to know about data visualization and storytelling,
from picking the right Python library to presenting charts your exec will actually understand.
Spoiler: the pie chart doesn't make it out alive.`,
      ...
      },
      {
        ...
        description: `Is your Python code held together with duct tape and prayers?
Sam and Shifra untangle the spaghetti and show you what clean, maintainable data code actually looks like.
From the humble origins of pandas to the blazing speed of Polars and the SQL simplicity of DuckDB,
this episode is your guide to leveling up without burning down your codebase.`,
      ...
      },
      {
        ...
        description: `What happens when you train an evil AI and it just lies really confidently?
[Joey Yudelson](https://www.linkedin.com/in/joseph-yudelson/), AI safety researcher at Redwood Research,
joins Sam and Shifra to break down why 300 people standing between us
and a catastrophic AI future might not be enough,
and what data folks can actually do about it.`,
      ...
      },
      {
        ...
        description: `We're just getting started! New episodes dropping on terminal mastery,
SQL fundamentals, Python essentials, performance optimization, and AI safety.
Subscribe to stay updated on technical deep-dives, career guidance, and special guest appearances.`,
    ...
    items: [
      {
        ...
        description: `Shifra joins FP&A Today with Glenn Hopper to break down data science methods for finance professionals,
from data ingestion to machine learning and ARIMA models in Excel.`,
      ...
      },
      {
        ...
        description: `Sam joins Ready Set Do with Naman Pandey to share his experience breaking into data engineering
and the key strategies for landing data engineering roles.`,
      ...
      },
      {
        ...
        description: `Shifra joins Ready Set Do with Naman Pandey to share how professionals can leverage LinkedIn
to grow their careers, build networks, and create opportunities for advancement.`,
      ...
      },
      {
        ...
        description: `Shifra joins Ready Set Do with Naman Pandey to share their journey from music to data
and practical strategies for transitioning to tech from any background.`,
      ...
      },
      {
        ...
        description: `Shifra and Sam join the Net Result with Ben Smith to discuss the transformative role
of data science in the healthcare industry.
Discover how cutting-edge data analytics is reshaping patient care, streamlining operations, and driving innovation.`,
